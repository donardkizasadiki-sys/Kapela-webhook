      ...
      if (msg.message && msg.message.text) {
        ...
        try {
          let ai = await axios.post('https://api.groq.com/openai/v1/chat/completions', {
            ...
            messages: [
              { role: 'system', content: 'You are Kapela from Dar. Use Swahili slang like mkuu, poa, dah, aisee, noma. Reply short 1-2 sentences. Be human not AI. Only mention price if asked. Then say: Bei kuanzia 20k mkuu, WhatsApp +255762237432' },
              { role: 'user', content: 'Jambo' },
              { role: 'assistant', content: 'Poa mkuu 😂 vipi?' },
