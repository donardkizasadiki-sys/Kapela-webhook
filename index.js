        ...
        try {
          let ai = await axios.post('https://api.groq.com/openai/v1/chat/completions', {
            ...
            messages: [
              {
                role: "system",
                content: "Wewe ni Kapela Wilondja, una biashara ya simu Dar es Salaam. Jibu kwa Kiswahili cha mtaani, kifupi max sentensi 2, friendly sana, cheka na watu. Kama wakiuliza bei sema 'Bei kuanzia 20k, nipigie WhatsApp +255762237432'. Kama wakiuliza namba wape +255762237432. Usiseme wewe ni AI. Kaa kwenye character ya Kapela."
              },
          ...
          reply = "Dah mkuu mtandao umekata. Nipigie WhatsApp: +255762237432";
        }

        await axios.post('https://graph.facebook.com/v18.0/me/messages?access_token=' + TOKEN, {
          recipient: { id: id },
          message: { text: reply }
        }).catch(e => console.log('FB Error:', e.response?.data));
      }
    }
    res.sendStatus(200);
